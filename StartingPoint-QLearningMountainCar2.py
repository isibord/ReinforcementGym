...
actionProbabilityBaseList = [1.0, 1.5, 2.0, 2.5, 2.7]
for actionProbabilityBase in actionProbabilityBaseList:
    totalscore = 0
    for numTrials in range(10):
        ...
        print(actionProbabilityBase, numTrials, sum(totalRewards) / float(len(totalRewards)))
    print(actionProbabilityBase, totalscore/10.0)
