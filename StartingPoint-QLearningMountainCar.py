...
actionProbabilityBase = 1.83  # This is k from the P(a_i|s) expression from section 13.3.5 and influences how random exploration is
...
discountRateList = [1]
for discountRate in discountRateList:
    totalscore = 0
    for numTrials in range(10):
        ...
        print(discountRate, numTrials, sum(totalRewards) / float(len(totalRewards)))
    print(discountRate, totalscore/10.0)
