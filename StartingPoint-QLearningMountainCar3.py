...
trainingIterationsList = [15000, 25000, 30000, 40000, 50000]
for trainingIterations in trainingIterationsList:
    totalscore = 0
    for numTrials in range(10):
        ...
        print(trainingIterations, numTrials, sum(totalRewards) / float(len(totalRewards)))
    print(trainingIterations, totalscore/10.0)
