...
def MountainCarObservationToStateSpaceExt(observation, binsPerDim):
    return [ _DimensionBinIndex(mountainCarLow[i], mountainCarHigh[i], binsPerDim, observation[i]) for i in range(len(mountainCarLow)) ]
